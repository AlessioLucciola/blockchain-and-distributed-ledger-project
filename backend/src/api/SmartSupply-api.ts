...
const SmartSupplyAPI = (app: Express) => {
	...
	app.patch("/api/product-change-on-sale-manufacturer", SmartSupplyController.productChangeOnSaleManufacturer)
	app.patch("/api/product-change-on-sale-distributor", SmartSupplyController.productChangeOnSaleDistributor)
	app.patch("/api/product-change-on-sale-retailer", SmartSupplyController.productChangeOnSaleRetailer)
	...
	app.patch("/api/ship-product", SmartSupplyController.shipProduct)
	app.get("/api/get-sold-products", SmartSupplyController.getSoldProducts)
	app.patch("/api/receive-product", SmartSupplyController.receiveProduct)

	//Debug
	app.put("/api/add-product-instance-for-demo", SmartSupplyController.addProductInstanceForDemo)
}
