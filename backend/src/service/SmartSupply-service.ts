...
class SmartSupplyService {
	...
	async addProductInstance({ productInstanceId, productId }: { productInstanceId: number; productId: number }) {
		return this.repository.addProductInstance({ productInstanceId, productId })
	}
}
