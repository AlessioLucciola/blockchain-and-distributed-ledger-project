...
import { addCustomer, addManufacturer, grantVerificationPermission, isCustomer, isDistributor, isManufacturer, isRetailer, isVerificationPermitted, isVerified, removeDistributor, removeManufacturer, verifyEntity } from "../assets/api/contractCalls"
				...
				<div className="flex flex-col h-full w-full pl-36 items-center justify-center">
					<div className="flex flex-col h-fit w-fit gap-6">
						...
						<div className="flex flex-row w-full  items-center justify-between relative">
							...
							<Button text="test" onClick={() => verifyEntity()} />
